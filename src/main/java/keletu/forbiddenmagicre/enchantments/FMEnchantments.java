...
public class FMEnchantments {
    ...
    public static EnumInfusionEnchantment EDUCATIONAL = EnumHelper.addEnum(EnumInfusionEnchantment.class, "EDUCATIONAL", new Class<?>[]{Set.class, int.class, String.class}, ImmutableSet.of("weapon"), 5, "INFUSIONENCHANTMENTFM");
