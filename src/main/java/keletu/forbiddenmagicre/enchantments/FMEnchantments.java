...
public class FMEnchantments {
    ...
    public static EnumInfusionEnchantment CONSUMING = EnumHelper.addEnum(EnumInfusionEnchantment.class, "EDUCATIONAL", new Class<?>[]{Set.class, int.class, String.class}, ImmutableSet.of("axe", "pickaxe", "shovel"), 1, "INFUSIONENCHANTMENTFM");
