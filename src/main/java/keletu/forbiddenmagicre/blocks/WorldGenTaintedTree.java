...
public class WorldGenTaintedTree extends WorldGenAbstractTree {
    ...
    private static final IBlockState LOG = ModBlocks.BLOCK_LOG_TAINTED.getDefaultState();
    private static final IBlockState LEAF = ModBlocks.BLOCK_LEAVES_TAINTED.getDefaultState();
